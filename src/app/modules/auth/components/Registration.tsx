...
import TextButton from '../../../components/button-link/MetricCard'
      ...
      {showPopup ?
        (
          <Popup
            ...
            message='Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt maxime dolorem asperiores laboriosam ad delectus ea. Tempora tempore repellendus laudantium fugiat saepe mollitia eius illo possimus laborum consequuntur, tenetur neque.'
    ...
    >
      ...
      <div className='fv-row mb-10'>
        <div className='form-check form-check-custom form-check-solid'>
          ...
          >
            {'I agree to the '}
                  <TextButton onClick={handlePopupOpen} >
